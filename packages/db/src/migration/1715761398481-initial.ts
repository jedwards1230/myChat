...
export class Initial1715761398481 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`CREATE TABLE "document" ("id" SERIAL NOT NULL, "decoded" text NOT NULL, "metadata" jsonb NOT NULL, "threadId" uuid, "userId" uuid, "messageId" uuid, "embeddingId" SERIAL NOT NULL, "embeddingEmbedding" text NOT NULL, CONSTRAINT "PK_192b1e32c8de842edb0ad8d4444" PRIMARY KEY ("id", "embeddingId"))`
		);
		await queryRunner.query(
