...
export const getToolCallRepo = () => AppDataSource.getRepository(ToolCall).extend({});

export const getMessageRepo = () =>
	AppDataSource.getTreeRepository(Message).extend({
		/**
		...
		async getMessageHistoryList(
			...
			try {
				...
				logger.error({
					error: e,
					functionName: "MessageRepo.getMessageHistoryList",
				});
				throw e;
			}
		},
